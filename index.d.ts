 ...
 */
export declare type Curried<A extends any[], R> = <P extends Partial<A>>(...args: P) => P extends A ? R : A extends [...SameLength<P>, ...infer S] ? S extends any[] ? Curried<S, R> : never : never;
export declare type SameLength<T extends any[]> = Extract<{
    [K in keyof T]: any;
}, any[]>;
